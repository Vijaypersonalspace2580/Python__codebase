...
def search_contact():
    while True:
        choice = input('Do you search by name or phone number(n/p): ')
        if choice == 'n':
            while True:
                name = input('Enter name: ')
                name = name.lower()
...
def delete_contact():
    while True:
        choice = input('Do you delete by name or phone number(n/p): ')
        if choice == 'n':
            while True:
                name = input('Enter name: ')
                name = name.lower()
...
def update_contact():
    while True:
        choice = input('Do you update Name or Phone number(n/p): ')
        if choice == 'n':
            while True:
            ...
            while True:
                ...
                if (len(old_phone) == 10 and old_phone.isdigit()) and (
                        len(new_phone) == 10 and new_phone.isdigit() == True) == True:
